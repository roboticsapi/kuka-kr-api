...
public class StatusTurn {
	...
	/*
	 * Returns an array containing values for each axis. False for negative range (<
	 * 0°), true for positive range and zero (>= 0°).
	 */
	...
	/*
	 * Returns the status of given Axis. True if negative (<0), false if positive or
	 * zero (>=0).
	 */
